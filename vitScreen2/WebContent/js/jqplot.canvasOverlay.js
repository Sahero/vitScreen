...
(function($) {
                ...
                for (var n in obj) {
                    switch (n) {
                        ...
                        case 'dashedHorizontalLine':
                            ...
                            break;
                        case 'dashedHorizontalLine2':
                            this.addDashedHorizontalLine(obj[n]);
                            break;
                        case 'dashedHorizontalLine3':
                            this.addDashedHorizontalLine(obj[n]);
                            break;
                        case 'verticalLine':
    ...
    function DashedHorizontalLine(options) {
        ...
        var opts = {
            ...
            xmin: null,
            xmax: null,
            xOffset: '1px', // number or string.  Number interpreted as units, string as pixels.
            xminOffset: null,
            xmaxOffset: null,
            // prop: dashPattern
                        ...
                        case 'dashedHorizontalLine':
                            ...
                            if (obj.options.y != null) {
                                ...
                                if (xstop != null && xstart != null) {
                                   ...
                                   // applyChartText(plot, obj.options.name,y);
                                    //console.log(y);
 ...
 // Sagar Shrestha for Label//
    function createLabel(plot, line) {
        ...
        element.css('color',line.options.color);
        element.css('font-size',line.options.fontsize);
...
// Sagar Shrestha for Label//
    ...
    function showTooltip(plot, obj, gridpos, datapos) {
      ...
      //  var opts = obj.options, x, y;
        var opts = obj.options, positions;//Sagar Shrestha for Label
